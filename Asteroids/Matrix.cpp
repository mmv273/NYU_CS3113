...
Vector Matrix::operator * (const Vector &v2){
	...
	result.x = m[0][0] * v2.x + m[1][0] * v2.y + m[2][0] * v2.z + m[3][0] * 1.0f;
	result.y = m[0][1] * v2.x + m[1][1] * v2.y + m[2][1] * v2.z + m[3][1] * 1.0f;
	result.z = m[0][2] * v2.x + m[1][2] * v2.y + m[2][2] * v2.z + m[3][2] * 1.0f;
