...
void SpaceInvaders::renderMenu(){
	drawText("font2.png", "Welcome to Space Invaders", -0.7f, 0.0f, 0.06f, 1.0f, 1.0f, 1.0f, 1.0f);
	drawText("font2.png", "Press esc to quit", -0.7f, -0.2f, 0.06f, 1.0f, 1.0f, 1.0f, 1.0f);
	}
...
void SpaceInvaders::renderGameOver(){
	glClearColor(0.0, 0.0, 0.0, 0.0);
	drawText("font2.png", "GAME LOST Good Try", -0.8f, 0.4f, 0.2f, 1.0f, 1.0f, 1.0f, 1.0f);
	drawText("font2.png", "SCORE: " + to_string(score), -0.8f, 0.0f, 0.1f, 1.0f, 1.0f, 1.0f, 1.0f);
	drawText("font2.png", "Press esc to quit.", -0.8f, -0.4f, 0.1f, 1.0f, 1.0f, 1.0f, 1.0f);
...
void SpaceInvaders::renderWinner(){
	glClearColor(0.0, 0.0, 0.0, 0.0);
	drawText("font2.png", "WINNER WINNER", -0.8f, 0.4f, 0.1f, 1.0f, 1.0f, 1.0f, 1.0f);
	drawText("font2.png", "FINAL SCORE: " + to_string(score), -0.8f, 0.0f, 0.1f, 1.0f, 1.0f, 1.0f, 1.0f);
	drawText("font2.png", "PRESS ESC.", -0.8f, -0.4f, 0.1f, 1.0f, 1.0f, 1.0f, 1.0f);
